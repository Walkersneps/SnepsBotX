...
public class CommandMap {
    ...
    public static void loadCommandsOnStartup () {
        ...
        c.put("spams", "Syntax: spams {on/off} (enables or disables spam functions");
        ...
        c.put("stalks", "Syntax: stalk {on/off} (toggles the ability to use stalk commands).");
        ...
        c.put("leave", "Syntax: leave (leaves the channel where it's cast from).");
        c.put("part", "Syntax: part <channel> (parts the specified channel).");
